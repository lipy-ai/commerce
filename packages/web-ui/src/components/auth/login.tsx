...
export function LoginForm({
  ...
  return (
    <Card className="flex w-full max-w-sm flex-col gap-6 mx-auto mt-auto md:m-auto py-8 shadow-none border-0 bg-transparent">
      ...
      <div className={cn("flex flex-col gap-6", className)} {...props}>
        <div className="space-y-4">
          ...
          <CardHeader className="text-center">
            <CardDescription>Log in or Sign</CardDescription>

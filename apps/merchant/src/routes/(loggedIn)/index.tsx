...
function RouteComponent() {
	...
	const [storeFullySet] = useState(false);

	return (
		<div className="h-full">
			<div className="flex gap-4 px-4 py-4 lg:p-0 items-center lg:hidden border-b">
				...
				<div>
					<p>Welcome to,</p>
					<h1 className="text-2xl">{activeOrg?.name || "Store"}</h1>
				</div>
			</div>

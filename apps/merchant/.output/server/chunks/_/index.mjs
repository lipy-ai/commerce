...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(jsxRuntime);

const require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(d);

const require$$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(dateFns);

const require$$3 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(locale);

(function (exports) {

	var jsxRuntime = require$$0;
	var react = require$$1;
	var dateFns = require$$2;
	var locale = require$$3;
